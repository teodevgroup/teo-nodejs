...
function fixIndexDTs(filename) {
  ...
  .replace("_defineModelHandlerGroup", "defineModelHandlerGroup")
  .replace("_defineRequestMiddleware", "defineRequestMiddleware")
  .replace("_defineHandlerMiddleware", "defineHandlerMiddleware")
