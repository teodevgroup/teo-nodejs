...
impl HandlerGroup {
    ...
    pub fn define_handler(&'static mut self, name: String, callback: JsFunction) -> Result<()> {
        let threadsafe_callback: ThreadsafeFunction<teo::prelude::Request, ErrorStrategy::CalleeHandled> = callback.create_threadsafe_function(0, |ctx: ThreadSafeCallContext<teo::prelude::Request>| {
        ...
        self.builder.define_handler(name.as_str(), move |ctx: teo::prelude::Request| {
